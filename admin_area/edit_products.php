...
if (isset($_GET['edit_products'])) {
    ...
    if ($result) {
        ...
        if ($row) {
            ...
            $select_category = "SELECT * FROM `categorie` WHERE category_id=$category_id";
    ...
    <form action="" method="post" enctype="multipart/form-data">
        ...
        <label for="product_category" class="form-label">Product Category</label>
            <select name="product_category" class="form-control">
                ...
                <?php 
                 $select_category_all="select * from `categorie`";
...
if(isset($_POST['edit_product'])){
    ...
    // }else{
        ...
        $update_product = "UPDATE `product` SET product_title='$product_title', product_description='$product_desc', product_image1='$product_image1', product_image2='$product_image2', product_image3='$product_image3', product_price='$product_price', date=NOW() WHERE product_id=$edit_id";
