...
if(isset($_GET['edit_category'])){
    ...
    $get_categories = "SELECT * FROM `categorie` WHERE category_id = $edit_category";
    ...
    if (mysqli_num_rows($result) > 0) {
        ...
        $categories_title = $row['category_title']; // Update the column name here
    }
...
if(isset($_POST['edit_cat'])){
    ...
    $update_query="UPDATE `categorie` SET category_title='$cat_title' WHERE category_id = $edit_category";
