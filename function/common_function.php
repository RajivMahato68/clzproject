 ...
 if(isset($_GET['add_to_cart'])){
  ...
  if($num_of_rows>0){
    ...
    echo "<script>window.open('index.php','_self')</script>";
      ...
      $insert_query="insert into `cart_detail` (product_id,ip_address,quantity) values ($get_product_id,'$get_ip_add',0)";
...
//get pending details
    ...
    function get_user_order_details() {
      ...
      $get_details = "SELECT * FROM `user_tables` WHERE username='$username'";
